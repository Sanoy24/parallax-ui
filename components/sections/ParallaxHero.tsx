...
export default function ParallaxHero() {
  ...
  // Stats Layer (Slides in from bottom to join the text)
      ...
      <div className="sticky top-0 h-screen overflow-hidden flex flex-col items-center justify-center">
        ...
        >
          <div className="pointer-events-auto mt-[-100px]">
            ...
            >
              <span className="block gradient-text">A new economic primitive</span>
              <span className="block gradient-text">for funding decentralized AI</span>
            </motion.h1>
